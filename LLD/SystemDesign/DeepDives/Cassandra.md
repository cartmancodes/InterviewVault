...
![Cassandra Data Model](assets/kEUE-HAXcD44.2nt84k78x6wgq.svg)
...
![Replication](assets/etkFPa_prKTZ.3ag0_xiyl0tai.svg)
...
![Query Routing](assets/LnCMRn3Q134K.1u97noggm4_br.svg)
...
![Storage Model](assets/zGgV2Ow86MhW.1s0p9lc8hjyw6.svg)
...
![Fault Tolerance](assets/0Y0zRmG33BGt.3_p37gu30r-r5.svg)
...
![Ticketmaster venue map with section popovers](assets/cassandra-1.0xy3zvnvvj4k4.png)

If a user clicks into a section of interest, Ticketmaster's UI then shows the individual seats and ticket information.

![Ticketmaster individual seat view](assets/cassandra-2.2ve2ifzbgu-3j.png)
