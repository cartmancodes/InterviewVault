...
![Random vs. Sequential I/O](assets/J2NbNOf7nXh3.1_k5pihxuwzl2.svg)
...
![LSM Model](assets/7NbGP3nd_rGk.2jn0iblldxvy8.svg)
...
Bloom filters (more on Bloom Filters in our [Data Structures for Big Data deep dive](https://www.hellointerview.com/learn/system-design/deep-dives/data-structures-for-big-data)) solve this elegantly.
...
This is a form of pre-computation that trades storage and write amplification for dramatically faster reads on historical data. If you want to see downsampling in action in a problem context, check out our [Ad Click Aggregator breakdown](https://www.hellointerview.com/learn/system-design/problem-breakdowns/ad-click-aggregator) where we use this technique to handle billions of ad events.
