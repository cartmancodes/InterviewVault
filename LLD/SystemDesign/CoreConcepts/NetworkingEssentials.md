...
![OSI Layers](assets/B5c4KEuENPxB.2r7-h61f15b1u.svg)
...
![Simple HTTP Request](assets/cvOR4cCwIO9k.0h5q3zu7d0tfu.svg)
...
![Simple HTTP Request/Response](assets/H1gTar0isNJz.1pa8cxsbnoo8a.svg)
...
![Under-Fetching Example - Page requires a lot of API calls to render](assets/KXYfVUzeUMyb.0bu2-gaifwajx.svg)
...
![Over-Fetching Example - Results take too long and have far more data than the frontend needs](assets/tjntWW1DLrY-.2jgeqs5x5-efz.svg)
...
![Example of Using gRPC for Internal APIs, and REST and HTTP for External](assets/QPaz7gvLzESP.1r3w08bh_nq7-.svg)
...
![WebSocket API Example](assets/DElga39lrtz-.1cd_jfppgwy_q.svg)
...
![Vertical vs Horizontal Scaling](assets/gz2YPLIbmlVE.2t1r4_aqc-l8r.svg)
...
![How do we route our traffic?](assets/A2ooJ0ht9qtM.18tch993vobcn.svg)
...
![When to Use Client-Side Load Balancing](assets/pc4frD_W9Vme.17otsj8h5_z62.svg)
...
![Dedicated Load Balancer](assets/km3Yj8m6-r4B.2hzl4s-a2f4gk.svg)
...
![Simple HTTP Request with L4 Load Balancer](assets/-blLoTPnJ-PE.3k_db_b7zdzpv.svg)
...
![Simple HTTP Request with L7 Load Balancer](assets/Lgk4gsoL2L_6.2as4camcs-sd7.svg)
