...
![In-Process Rate Limiter](assets/WrBe185VAKtk.0ujah-mj7sxxh.svg)
...
![Dedicated Service Rate Limiter](assets/f2XQKhTNn_U3.3yt7mcj00g996.svg)
...
![API Gateway Rate Limiter](assets/qeaFVh4bVmxH.2jvstc4eb9ekc.svg)
...
![Fixed Window Counter](assets/Vv-0UWtdmhU7.2-8t8qae299xn.svg)
...
![Sliding Window Log](assets/saNxSqZNxcU1.1-pnxzpu98ppb.svg)
...
![Token Bucket](assets/5G0zTJJ58gkE.19446yvu_-fci.svg)
...
![Redis Sharding](assets/izkAUyMB-DfC.3wwk4ha_60pr4.svg)
...
![Redis Failover](assets/ncyq6th7trUV.3ptdj_v6fgd6r.svg)
...
Hot keys are often mentioned in system design discussions, and we do cover techniques for handling them in our [scaling reads pattern](https://www.hellointerview.com/learn/system-design/patterns/scaling-reads). For rate limiting, hot keys can arise from both abusive traffic and legitimate high-volume clients.
...
![ZooKeeper](assets/zBf1Mj2EGOz7.1m_zzr-tfln7h.svg)
