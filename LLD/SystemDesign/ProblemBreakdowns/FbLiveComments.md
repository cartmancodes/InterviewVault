...
> 🤩 Fun Fact! The most popular Facebook Live video was called Chewbacca Mom which features a mom thoroughly enjoying a plastic, roaring Chewbacca mask. It has been viewed over 180 million times. Check it out here .
...
![FB Live Comments Core Entities](assets/SCrlExDT-ceT.2h9-bfic30doq.svg)
...
![FB Live Comments Create Comment](assets/e662JcqFpQst.26zzyowhweo5g.svg)
...
![Polling](assets/KUA1CIW3M54P.1z0k-vvdwpi-m.svg)
...
> In your interview, if you already know the more accurate, yet complex, solution, you can jump right to it. Just make sure you justify your decision and explain the tradeoffs. In the case that you are seeing a problem for the first time, starting simple like this is great and sets a foundation for you to build upon in the deep dives.
...
![Websockets](assets/PGHNXr9JW1Fz.1kqroohaul-9x.svg)
...
![SSE](assets/DXZnadgi-Gxa.0u_btonihsge8.svg)
...
![Simple Pub/Sub](assets/vJUcEw_h216A.38_k927c4kkt3.svg)
...
![Pub/Sub with Layer 7 Load Balancer](assets/ROhUEcniJuqt.0btw1o_z8rces.svg)
...
![Dispatcher Service](assets/RECf4xB9pxiD.0-uzhixdogs97.svg)
