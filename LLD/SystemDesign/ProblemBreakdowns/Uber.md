...
![Uber Requirements](assets/D5z8XF10EO9s.009kca1u641to.svg)
...
![Uber Core Entities](assets/vELvvF0cPiLq.3te5o42p6u57s.svg)
...
![Uber Simple Fare Estimation](assets/djumalvJ67oy.36j66of5vmwik.svg)
...
2. **API Gateway**: Acting as the entry point for client requests, the API Gateway routes requests to the appropriate microservices. It also manages cross-cutting concerns such as authentication and [rate limiting](https://www.hellointerview.com/learn/system-design/problem-breakdowns/distributed-rate-limiter).
...
![Riders should be able to request a ride based on the estimated fare](assets/i60di8SMHkZ0.3ubdlhjo75l3v.svg)
...
![Upon request, riders should be matched with a driver who is nearby and available](assets/bYJolUkOr9cB.0d8y-u1y8v645.svg)
...
![Uber Simple Driver Accept](assets/0yNJk6wmNU4P.3th_w8cig9af_.svg)
...
![Real-Time In-Memory Geospatial Data Store](assets/39MKsicabM4Z.3uhjyhe7_3rc2.svg)
...
![Queue with Dynamic Scaling](assets/zksUbdcb65X0.1hnxmvc45j40b.svg)
