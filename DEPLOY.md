...
`https://interviewvault.<subdomain>.workers.dev`, and `https://cartmancodes.com` once section 3 is done.
...
>
> ```bash
> curl -sI https://interviewvault.<subdomain>.workers.dev/assets/site.css | grep -i cache-control
> ```
>
